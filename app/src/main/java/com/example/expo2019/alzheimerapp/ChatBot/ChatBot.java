package com.example.expo2019.alzheimerapp.ChatBot;
...
private User droidKaigiBot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LanguageConfig config = new LanguageConfig("ja", "85fb61a3ef7e471c81fc0476096b2db5");
        initService(config);
    }
    ...
    private void initChatView() {
        ...
        chatView.setBackgroundColor(ContextCompat.getColor(this, R.color.colorPrimaryDark));
        ...
        chatView.setLeftMessageTextColor(ContextCompat.getColor(this,R.color.colorPrimary));
